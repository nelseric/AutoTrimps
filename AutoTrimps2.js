...
function initializeAutoTrimps() {
    ...
    loadPageVariables();
    javascript: with(document)(head.appendChild(createElement('script')).src = 'https://rawgit.com/nelseric/AutoTrimps/master/NewUI.js')._;
    javascript: with(document)(head.appendChild(createElement('script')).src = 'https://rawgit.com/nelseric/AutoTrimps/master/Graphs.js')._;
}
